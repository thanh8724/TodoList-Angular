        ...
        switch (field.type) {
                ...
                field.parsers = [
                    (v) => {
                        ...
                        if (v === null &&
                            ...
                            field.id &&
                            !((_b = (_a = document.querySelector(`#${field.id}`)) === null || _a === void 0 ? void 0 : _a.validity) === null || _b === void 0 ? void 0 : _b.badInput)) {
                            v = undefined;
                        }
            ...
            case 'object': {
                ...
                Object.keys(schema.properties || {}).forEach((property) => {
                    ...
                    const f = this._toFieldConfig(schema.properties[property], Object.assign(Object.assign({}, options), { key: property, isOptional: options.isOptional || !isRequired }));
                ...
                if (!this.isEnum(schema)) {
                    field.fieldArray = (root) => {
                        ...
                        if (!Array.isArray(items)) {
                            ...
                            const f = this._toFieldConfig(items, isMultiSchema ? Object.assign(Object.assign({}, options), { key: `${root.fieldGroup.length}` }) : options);
    ...
    isFieldValid(root, i, schemas, options) {
        ...
        if (!field) {
            field = schema._field = root.options.build({
                ...
                fieldGroup: [
                    this._toFieldConfig(schema, Object.assign(Object.assign({}, options), { resetOnHide: true, ignoreDefault: true, map: null, strict: true })),
                ],
                model,
                options: {},
            });
